...
public class GlobalErrorsMessages {
   ...
   //public final static String EMAIL_NOT_EXISTS_ERROR = "Inserted email does not exists.";
   ...
   public final static String USER_ADD_EXISTING_SALE_TO_CART_ERROR = "Sale already added to cart.";
   public final static String CART_LINE_NOT_DELETED_ERROR = "Cart line not deleted.";
   public final static String EMPTY_CART_ERROR = "Order not possible, your Cart is empty.";
